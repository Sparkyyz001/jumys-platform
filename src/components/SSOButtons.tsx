    ...
    return (
        <div className="grid grid-cols-2 gap-3">
            <button
                ...
                className="inline-flex h-10 items-center justify-center gap-2 rounded-lg border border-[#2a2d3a] bg-[#13151f] px-3 text-sm font-medium text-gray-200 transition-all hover:bg-[#1a1d2b] disabled:opacity-50"
            >
